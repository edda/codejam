  ...
  class Generator < ::Thor::Group
    ...
    def create_data
      inside 'data' do
        ...
        template 'problem/small.in',  File.join(name.underscore, 'small.in')
        template 'problem/small.out', File.join(name.underscore, 'small.out')
        template 'problem/large.in',  File.join(name.underscore, 'large.in')
        template 'problem/large.out', File.join(name.underscore, 'large.out')
      end
    end
